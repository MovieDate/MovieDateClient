package com.example.zhuocong.comxzc9.utils;
 ...
 */
public class DateTimeDialogUtils extends AlertDialog implements RadioGroup.OnCheckedChangeListener, ViewPager.OnPageChangeListener, TimePicker.OnTimeChangedListener, DatePicker.OnDateChangedListener, View.OnClickListener {
     ...
     */
    public DateTimeDialogUtils(Context context, MyOnDateSetListener myOnDateSetListener) {
     ...
     * @param myOnDateSetListener 监听器
     */
    public DateTimeDialogUtils(Context context, Date date, MyOnDateSetListener myOnDateSetListener) {
        super(context);
        this.date = date;
